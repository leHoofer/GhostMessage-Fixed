...
stylesheet.insertRule(".buttonWrapper-1ZmCpA {  }", 0);
					...
					return class GhostMessageFIXED extends Plugin {
						...
						getSettingsPanel() {
							...
							return Settings.SettingPanel.build(this.saveSettings.bind(this), 
								new Settings.SettingGroup("Plugin Options", {shown: true}).append(
									...
									], (e) => {this.settings.buttonEnabled = e; if (this.settings.buttonEnabled == false ){ ghostButton.setAttribute("style", "display: none;") }  else { ghostButton.setAttribute("style", "margin: 0px; padding: 0px;") }; }),
								...
								if (
									...
									if (
										...
										ghostButtonInner.className = KSS.createClassName(
											"|contents| |pulseButton button| |button| ghost-button-inner"
										);
										...
										ghostButtonMask.setAttribute("width", "18px");
										ghostButtonMask.setAttribute("height", "18px");
										...
										if (this.settings.buttonEnabled == false ){ console.log("disabled"); ghostButton.setAttribute("style", "display: none;") }  else { console.log("enabled"); ghostButton.setAttribute("style", "margin: 0px; padding: 0px;") };
						...
						setEnabled(set) {
							...
							if (ghostInner && ghostInner.children[0] && enabled) {
								...
								ghostButton.setAttribute("style", "margin: 0px; padding: 0px;")
							}
						}
